...
listoflibrary<-c("purrr", "ggplot2", "ggpubr", "car", "viridisLite", "viridis", "readxl", "data.table","raster",
                 "geosphere", "seegSDM", "mgcv", "tidyverse", "Rmisc",  "doParallel", "foreach", "parallel")
